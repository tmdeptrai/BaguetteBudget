...
def add_expense_tool(date: str, category: str, description: str, description_vi: str, fee: float, currency: str):
    return add_expense(date, category, description, description_vi, fee, currency)
